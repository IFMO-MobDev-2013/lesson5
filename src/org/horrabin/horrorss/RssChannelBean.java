...
/**
* The RssChannelBean object maps the element <i>channel</i> of an RSS FeedActivity.
...
public class RssChannelBean {
   ...
   * Create a new RssChannelBean.
   * 
   * @param title the title of the FeedActivity
   * @param link the URL to the FeedActivity web page
   * @param description the description of the FeedActivity
   */ 
  ...
  /**   
  * Sets the title of the FeedActivity
  * @param title the title of the FeedActivity
  */
  ...
  /** 
  * Sets the description of the FeedActivity
  * @param description the description of the FeedActivity
  */
  ...
  /** 
  * Sets the URL to the FeedActivity's web page
  * @param link The URL to the FeedActivity's web page
  */
  ...
  /** 
   * Sets the publication date of the FeedActivity
   * @param pubDate the publication date of the FeedActivity
   */      
  ...
  /** 
   * Returns the title of the FeedActivity
   * @return Title of the FeedActivity
   */    
  ...
  /** 
   * Returns the description of the FeedActivity
   * @return Description of the FeedActivity
   */    
  ...
  /** 
   * Returns the URL of the FeedActivity's web page
   * @return URL of the FeedActivity's web page
   */   
  ...
  /** 
   * Returns the last modification date of the FeedActivity
   * @return The last modification date of the FeedActivity
   */     
