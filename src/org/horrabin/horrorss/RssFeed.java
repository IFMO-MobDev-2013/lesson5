...
/**
* The RssFeed class maps the elements of an RSS FeedActivity
...
public class RssFeed {
	...
	/**
	 * Returns the FeedActivity channel element
	 * @return the FeedActivity channel element
	 */
	...
	/**
	 * Sets the FeedActivity channel element
	 * @param channel The FeedActivity channel element
	 */
	...
	/**
	 * Returns the FeedActivity image element
	 * @return the FeedActivity image element
	 */	
	...
	/**
	 * Sets the FeedActivity image element
	 * @param image The FeedActivity image element
	 */
	...
	/**
	 * Returns the FeedActivity items list
	...
	/**
	 * Sets the FeedActivity items list
	 * @param items The FeedActivity item list
	 */
